...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "evaluation.gate_select": "gate_select",
    "evaluation.sage_alpha": "sage_alpha",
    "evaluation.sage_loss_weight": "sage_loss_weight",
    "evaluation.sage_regression_tau": "sage_regression_tau",
